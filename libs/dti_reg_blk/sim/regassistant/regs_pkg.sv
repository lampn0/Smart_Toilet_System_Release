...
package regs_pkg;
   ...
   class stt extends uvm_reg;
      ...
      uvm_reg_field rfu; // Reserved for Future Use
      uvm_reg_field discharge; // Status Discharge
      ...
      // 
      covergroup cg_vals;
         discharge	 : coverpoint discharge.value[0];
      ...
      virtual function void build();
         rfu = uvm_reg_field::type_id::create("rfu");
         discharge = uvm_reg_field::type_id::create("discharge");
         ...
         discharge.configure(this, 1, 4, "RO", 0, 1'b0, 1, 0, 0);
   ...
   class regs extends uvm_reg_block;
      `uvm_object_utils(regs)
      ...
      virtual function void build();
         ...
         reg_stt.add_hdl_path_slice("stt_discharge", 4, 1);
